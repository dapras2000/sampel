      ...
      <div class="col-md-14">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel" style="text-align: center;padding-right: 0px">Data Jabatan <button type="button" class="close" aria-label="Close" onclick="$('#ModalJabatan').modal('hide');"><span>&times;</span></button></h4>                        
                    </div>
