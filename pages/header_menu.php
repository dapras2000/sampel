...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <div class="container">
      <a class="navbar-brand" href="index.php"> SDIT PELITA HATI - BATANG 
        </a>
      <div class="navbar-custom-menu" style="padding: 0 0 0 0;margin: 0 auto;">
        <ul class="nav navbar-nav" style="list-style: none;padding: 0;margin: 0 auto;font-size: 1px;margin-top: 8px;">
          ...
          <li style="display: block;margin:0;padding:0;float: left;"><a href="?p=pegawai" style="width: 100%;padding: 0.5em;"><button class="btn btn-default" style="color:red;padding: 5px 10px;">Pegawai <i class="fa fa-user-plus"></i></button></a></li>
          <?php } ?>
         ...
         <?php if ($seskdlvl=='Admin'){?>
          ...
          <?php if ($seskdlvl=='Admin'){?>
           <li class="dropdown" style="display: block;margin:0;padding:0;float: left;">
            ...
            <ul class="dropdown-menu">
              <li class="header"><a href="?p=jabatan">Jabatan</a></li>   
               <li class="header"><a href="?p=status">Status Pegawai</a></li> 
               <li class="header"><a href="?p=statusnikah">Status Pernikahan</a></li> 
               <li class="header"><a href="?p=tunjanganjabatan">Tunjangan Jabatan</a></li> 
            </ul>
          </li><?php } ?>
